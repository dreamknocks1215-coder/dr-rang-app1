...
st.markdown("<h3 style='text-align: center; color: #ffcc00; margin-top: 5px; font-weight: normal; font-size: 1.2rem; white-space: nowrap;'>당신의 스토리가 음악이 되는 공간</h3>", unsafe_allow_html=True)
